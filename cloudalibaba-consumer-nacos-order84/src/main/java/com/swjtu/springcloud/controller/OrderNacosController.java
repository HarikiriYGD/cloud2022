...
public class OrderNacosController {
    ...
    private static final String SERVICES_URL = "http://nacos-payment-provider";
    ...
    public CommonResult<Payment> fallback(@PathVariable Long id) {
        CommonResult<Payment> result = restTemplate.getForObject(SERVICES_URL + "/paymentSQL/" + id, CommonResult.class, id);
